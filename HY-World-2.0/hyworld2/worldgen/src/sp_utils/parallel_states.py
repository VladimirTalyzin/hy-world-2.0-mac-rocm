...
class ParallelDims:
    ...
    def build_mesh(self, device_type):
        ...
        if not dist.is_available() or self.world_size == 1:
            # Builds without a c10d backend cannot make a DeviceMesh at all, and
            # a single-rank mesh says nothing. Consumers check sp_enabled first.
